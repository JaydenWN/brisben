...
const defaultServices = [
	{
		...
		text: "From market research to user personas, we help you build products that matter.",
	},
	{
	...
	},
	{
		...
		text: "Robust, scalable applications built with modern technologies and frameworks.",
	},
	{
		icon: <Shrub className="h-8 w-8" />,
		title: "Marketing",
		text: "Strategic growth initiatives to scale your product and maximize impact.",
	},
];
