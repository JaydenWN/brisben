				...
				<div className="mx-auto flex max-w-7xl flex-col justify-between gap-10 lg:flex-row lg:gap-20">
					<div className="mx-auto flex max-w-sm flex-col justify-between gap-10">
						<div className="text-center lg:text-left flex-col gap-4 flex">
							<h2 className="mb-2 text-5xl font-semibold lg:mb-1 ">{title}</h2>
					...
					<form
						...
						method="POST"
						data-netlify="true"
						className="mx-auto flex max-w-3xl flex-col h-fit gap-6 rounded-lg border border-border bg-white p-10"
					>
