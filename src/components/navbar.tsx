...
import { Book, Menu, PhoneCall, PhoneIcon, Sunset, Trees, Zap } from "lucide-react";
...
import { SITE_TITLE, TEL_NUMBER } from "@/consts";
...
export default function Navbar({
  ...
  return (
    <section className="fixed top-0 z-50 w-full bg-white border-b border-border">
        ...
        <nav className="hidden justify-between lg:flex">
          ...
          <div className="flex gap-2 my-auto">
            <Button asChild size="sm">
              <a href={`tel:${TEL_NUMBER}`} className="gap-3"><PhoneIcon/>{TEL_NUMBER}</a>
            </Button>
          </div>
        </nav>
            ...
            <Sheet>
              ...
              <SheetContent className="overflow-y-auto border-none">
                <SheetHeader className="pb-0">
                  ...
                  <SheetDescription>{SITE_TITLE}</SheetDescription>
                </SheetHeader>
                <div className="flex flex-col gap-6 p-4 h-full justify-between">
                  ...
                  >
                   ...
                   <Button asChild className="gap-3">
                      <a href={`tel:${TEL_NUMBER}`}><PhoneIcon/> Call Now</a>
                  </Button> 
                </div>
