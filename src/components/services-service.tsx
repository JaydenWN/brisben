...
export default function ServicesService({
	...
	return (
		<section
			className={cn(`${className} py-16 px-3 md:px-8 md:py-16 lg:py-32`)}
			id={id}
		>
			<div className="container mx-auto">
				<div className="grid items-center gap-8 lg:grid-cols-2">
					<img
						...
						alt={image.alt}
						className={cn(
							"rounded-md object-cover aspect-square lg:w-90 lg:mx-auto",
							variant === "reverse"
								? "order-2 lg:order-2"
								: "order-2 lg:order-1",
						)}
					...
					>
						<h2 className="my-6 text-5xl font-semibold">{title}</h2>
